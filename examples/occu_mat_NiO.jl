...
indices2 = DFTK.find_orbital_indices(orbital_name, psp.pswfc_labels)
orbital = DFTK.atomic_wavefunction(basis, 1)

@time occupation_matrix_1 = DFTK.build_occupation_matrix(scfres, 1, psps[1], scfres.basis, scfres.ψ, indices[2], indices[1], psp_positions[1][1])
occupation_matrix_2 = DFTK.build_occupation_matrix(scfres, 2, psps[2], scfres.basis, scfres.ψ, indices2[2], indices2[1], psp_positions[2][1])

...
scfres = load_scfres("scfres_single_atom.jld2")
...
@time occupation_matrix_single_1 = DFTK.build_occupation_matrix(scfres, psps[1], scfres.basis, scfres.ψ, indices[2], indices[1], psp_positions[1][1])
